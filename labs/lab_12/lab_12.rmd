...
sub <- paste("The most recent date of incidents in WVU was ", format(recent_incidents$date, format="%B %d")," with ",  recent_incidents$title, " that occurred  ", count(n),  sep="")
sub
  most_incidents%>%
...
maryland_zips<-read_csv("maryland_zips_yyyymmdd.csv")
non_maryland_zips<-read_csv("non_maryland_zips_yyyymmdd.csv")
