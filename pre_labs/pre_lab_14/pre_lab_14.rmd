...
**Answer**It shows the 152584 tweets that either have COVID or coronavirus in the tweet. 
...
**Answer**It brings up a list of the separate words used within the text. 
...
**Answer**It brings out a list of the various unique words from the tweets. 
...
**Answer**It gave the top words that many of the tweets has but it's very uninteresting. 
...
**Answer**Now there are words that weren't a major part of the previous list. It is very interesting than the previous list. 
...
**Answer**It gives the list of top 10 unique words in 2020(covid, health, crisis) and 2021(covid, pandemic, vaccine)
...
**Task** Run the following code and describe the results.
**Answer**It gives a list of top 10 double word texts in 2020 like covid 19, healthcare,public health.
...
**Task** Run the following code and describe the results.
**Answer**covid 19 is the most common two word phrase used on Twitter in 2021 but not as common as 2020. But healthcare went down. 
...
**Task** Run the following code and describe the results.
**Answer**Democrats said things along the lines of social distancing, relief package,and covid 19 while Republicans said things like amercian people, nursing home, god bless and covid 19
...
**Task** Run the following code and describe the results.
**Answer**2020- Republicans social distancing, nursing home, and american people as some of the main two phrases. 2021-The spoke of things like the Biden Administration, Joe Biden, Illegal Immigrants, and covid positive as part of the majority of two phrases. 
...
**Answer**It gave the dataframe of words and their "sentiments" Some of the words are counter-intutive as some of them were used negatively instead of positively. 
