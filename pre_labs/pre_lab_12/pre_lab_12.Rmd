...
**Answer**It holds the vaccination dates along with the counties and the number of first doses, second doses, and those who are fully vaccinated.
...
**Answer**One county is unknown and another is N/A. Neither of them are Maryland counties. 
...
**Answer**It represents the different amounts of doses given per county or by area. 

There are totals for all of Maryland's jurisdictions, plus one for "Unknown" and one that's NA. All but the last one have roughly the same number of records. What's going on with the NA records?They're saying that 8000 doses were given.
...
**Answer**A decrease in vaccines have been given. 
...
**Answer**The number of vaccinations decreased between March 2021 to Janurary 2022. 
...
**Answer**All the counties are showing their number of cases between July 2020 and January 2021.
...
**Task** Run the following code and describe what the resulting chart shows
**Answer**The chart now has a line to show cases not in Maryland during the same dates as the last chart. 
...
**Answer**It shows the amount of COVID cases since April 19, 2022 in Maryland. It appears that there are more cases near central Maryland than anywhere else. 
