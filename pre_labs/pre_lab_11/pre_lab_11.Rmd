...
**Answer**Different files that are named hospitals.
...
**Answer**A new dataframe based on the shp file. 
...
**Answer**It only shows Maryland hospitals on the dataframe.
...
What kind of hospitals do we have? General Acute care, Non profit,psychiatric,and medical/surgical hospitals.

### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It tallied up how many types of hospitals Maryland has with a geometry side to them.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It filtered the dataframe to only have general acute care hospitals.
...
That gives us 50 hospitals in Maryland. Where are they? Mainly in Baltimore, Maryland. 

We can simply plot them on a longitude-latitude grid using ggplot.

### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**The ggplot shows the hospitals in the state but it vaguely looks like the outline of Maryland.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It has the counties that within the U.S.
```{r}
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It got filtered down to only show Maryland counties. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It gives a clearer map of Maryland and its counties.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**All the hospitals have been plotted onto the map.
...
ggplot() + 
  ...
  theme_minimal()
```
What can we tell from this? Most of the hospitals are placed in Central Maryland. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**The map is now colored and there are legends to reporesent the number of beds in each hospital. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Same chart as previous dataframes.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It gave the list of counties based on how many beds were in the hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It gave us a list of the population of each county. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It gave a dataframe with the coutnies and a geometry column to it. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It gives the counties and the total beds in the hospitals.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Now the counties are uppercase and the NAME column is now the COUNTY column.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It created a new dataframe, however,two counties have N/A instead of 0.  
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**Now all counties have hospital beds numbers.
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It added the beds per 100k column to the dataframe. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**It shows a map of Maryland and the brighter an area is, the more beds the hospitals have. 
...
### Task: Run code
**Task** Run the following code. Describe the output in the space below.
**Answer**THe map colors changed to purple and a light orange color shows more beds are in a county. 
...
**Answer**Now we can clearly see which areas in Maryland have the most beds in their hospitals.
