...
**Answer**Some places aren't even cities but names.
...
**Answer**Phoenix became lowercased. Westminister also got lowercased.
...
**Answer**Abell got lowercase,Aberdeen had the A capitalized, and Aberdeen Proving Ground also got lowercased in the city_clean column.
...
**Answer**Not really. It looks the same as the previous use of key_collision_merge.
