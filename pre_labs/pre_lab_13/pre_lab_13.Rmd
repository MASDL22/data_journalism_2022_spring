...
**Answer**It shows that there's a 0.00008607 correlation that shows the number of loans given mostly to states who voted for Trump than states who voted for Clinton. 
```{r}
