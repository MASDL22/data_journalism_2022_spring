...
**Answer**The states who voted for Trump received more loans than states who voted for Clinton.
```{r}
...
**Answer**There is a positive correlation between trump and ppp loan businesses. 
```{r}
...
### Task 4: Plot data
**Task** Run the following code. Describe the plot. What do you see?
**Answer**The graph shows a bit of a mixed relationship between PPP loans and states who voted for Trump. 
```{r}
...
**Answer**Percent of Trump voters compared to businesses who recieved PPP loans.
```{r}
reveal_data %>%
...
**Answer**It shows that there's a 0.00008607 correlation that shows the number of loans given mostly to states who voted for Trump than states who voted for Clinton which might be some correlation. 
```{r}
...
**Task** Run the following code. Describe the model output. What do you see?
**Answer**There is a small possibility that states who mainly voted for Trump got better PPP loans.
```{r}
...
**Answer**Businesses that were within a state that voted fro Trump got higher and more loans than states who voted for Clinton. 
```{r}
reveal_data %>%
  group_by(vote_2016) %>%
  summarise(
...
**Answer**The test shows that there is a chance that Trump voted states got more loans than Clinton voted states. 
```{r}
...
### Task 10: Run t-test
**Task** Run the following code. Describe the output. What do you see?
**Answer**The test shows a higher chance that states who voted for Trump are getting more loans than states who voted for Clinton but it's not too reliable but worth looking at.
```{r}
