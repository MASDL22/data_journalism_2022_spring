...
```{r echo=FALSE}
census_api_key("23d86a0f3402e889b16419069579742ff2bf5476" install = TRUE)
```
...
**Answer**Nevada hqd the largest percentage growth.
...
**Answer**Not really because they're within the margin of error. 

Is the difference between Howard and everyone else significant?
**Answer**Depends on which counties they are since Howard county's margin of error is small. 
...
**Answer**Somerset and Caroline Counties had their median income fall from 2010-2019. It could be a change outside the margin of error.
...
**Answer**	
21202,21740,and 21201 have an estimated median household incomes of less than $50,000
