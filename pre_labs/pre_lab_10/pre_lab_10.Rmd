...
**Answer** Copy the url of the graphic you published here.https://datawrapper.dwcdn.net/AH7Ky/1/
...
There is an N/A as well as other counties not in Maryland. 
...
**Answer** Describe what the code below is doing and the output.
It filters out any code with 6 or less loans and brings up counties in Maryland. 
...
It combines the two columns together to make a fips code.
...
Now the uppercase version of the counties are under project_county_name and we have a fips code for each county as well as the state and county codes.
...
Now all of Maryland is showing and the darker the color is, the more loans a county has.
...
**Answer** Describe the changes from the previous map. 
Now the hover tool shows the county and how many loans the county had approved.
...
https://datawrapper.dwcdn.net/0Zcex/1/