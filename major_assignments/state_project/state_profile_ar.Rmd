...
**A4.** This question was very difficult to answer since I couldn't get the data frames to join together to make a map but I still got the answers to the top 10 industries in the PPP and CBP data frames. According to the PPP data frame, the top 10 industries were as follows
